...
export default class Reference extends ReferenceBase {
  ...
  _getRegistrationKey(eventType: string): string {
    return `$${this._database._appName}$/${this._database._url}${this.path}$${this._query.queryIdentifier()}$${listeners}$${eventType}`;
  }
   ...
   */
  _getRefKey(): string {
    return `$${this._database._appName}$/${this._database._url}${this.path}$${this._query.queryIdentifier()}`;
  }
